            ...
            <div>
                ...
                <section className="filter-options">
                    ...
                    <div className="member-input">
                        <input type="checkBox" onChange={handleChange} value={'1'} name="members" id="members" />
                    ...
                    {boardToShow.members.map(member =>{
                        return(
                            <div className="member-input">
                        <input type="checkBox" onChange={handleChange} value={member._id} name="members" id="members" />
                        <label className="member-label" htmlFor="members">
