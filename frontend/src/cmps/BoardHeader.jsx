...
color: (useDarkTextColors? '#172b4d': 'white')
}} ref={elFilter} className={`filters-btn ${isFilterd ? 'active' : ''}`} onClick={() => setShowFilter(true)}>
                        <svg width="24" height="24" role="presentation" focusable="false" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {isFilterd && <button onClick={clearFilter} className="clear-filter">Clear all</button>}
                </div>
                ...
                <button className="dots-at-end" style={{

color: (useDarkTextColors? '#172b4d': 'white')
}}>
                    <svg onClick={onSetActivityMenu} width="24" height="24" role="presentation" focusable="false" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
