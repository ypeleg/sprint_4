...
export function AppHeader({backgrounColor, borderColor, useDarkTextColors,
    ...
    return (<header className="board-index-header" style={{
            ...
            <nav className="flex-space-between center-vertical">
                ...
                <div className="just-flex just-flex-more center-vertical">
                    ...
                    <div className="btn-popup-container">
                        <div className="dropdown-menu nav-highlight-hint" onClick={() => {closeAllPopups(); setShowWorkspace(!showWorkspace)}}>
                    ...
                    <div className="btn-popup-container">
                        <div className="dropdown-menu nav-highlight-hint" onClick={() => {closeAllPopups(); setShowRecent(!showRecent)}}>
                    ...
                    <div className="btn-popup-container">
                        <div className="dropdown-menu nav-highlight-hint" onClick={() => {closeAllPopups(); setShowStarred(!showStarred)}}>
                            <span>Starred</span> <i className="fa-regular fa-chevron-down"></i>
                        </div>
                        {showStarred && (<>
                            <div className="header-popup recent-popup popup-opens-right">
                ...
                <div className="just-flex and-center just-flexer">
                    <div className="btn-popup-container">
                        <button className="days-left just-flex" onClick={() => {closeAllPopups(); setShowPremiumTrial(!showPremiumTrial)}}>
                        ...
                        {showPremiumTrial && (<>
                            ...
                            <div className="btn-popup-container just-flexer">
                                <svg width="24" height="24" viewBox="0 0 24 24" role="presentation" onClick={() => {closeAllPopups(); setShowBellPopup(!showBellPopup)}}>
                                            ...
                                            <div className="notifications-header">
                                                ...
                                                <div className="header-controls">
                                                    <div className="toggle-container">
                                                        ...
                                                        <button className={`toggle-switch ${showUnreadOnly ? 'active' : ''}`} onClick={() => {closeAllPopups(); setShowUnreadOnly(!showUnreadOnly)}} role="switch" aria-checked={showUnreadOnly}>
                            ...
                            <div className="btn-popup-container just-flexer">
                                <svg width="24" height="24" role="presentation" focusable="false" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" onClick={() => {closeAllPopups(); setShowQuestionMarkPopup(!showQuestionMarkPopup)}}>
