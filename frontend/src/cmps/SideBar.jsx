        ...
        <aside className="side-bar">
            ...
            <section>
                <article className="sidebar-first-section">
                    ...
                    <div className="side-bar-item flex-space-between nav-highlight-hint">
                        <span>
                            <svg width="16" height="16" role="presentation" focusable="false" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M12.0254 3C9.25613 3 7.01123 5.23858 7.01123 8C7.01123 10.7614 9.25613 13 12.0254 13C14.7946 13 17.0395 10.7614 17.0395 8C17.0395 5.23858 14.7946 3 12.0254 3ZM9.01688 8C9.01688 9.65685 10.3638 11 12.0254 11C13.6869 11 15.0338 9.65685 15.0338 8C15.0338 6.34315 13.6869 5 12.0254 5C10.3638 5 9.01688 6.34315 9.01688 8Z" fill="currentColor"></path><path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <div className="side-bar-item flex-space-between nav-highlight-hint">
                        <span>
                            <svg width="16" height="16" role="presentation" focusable="false" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <section>
                ...
                <article>
                    ...
                    {boards.map(board => {
                        return (<div className="side-bar-item side-bar-item-third flex-space-between nav-highlight-hint">
