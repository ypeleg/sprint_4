...
const initialBoardData = {
    ...
    "style": {
        "backgroundImage": "https://images.unsplash.com/photo-1532635249-24453f539b25",
    ...
    "cmpsOrder": ["member-picker", "status-picker", "date-picker", "priority-picker", "updated-picker"],
            ...
            "tasks": [
                {
                    ...
                    "_id": "c101",
                    "title": "Replace logo",
                    "description": "We need to change the old logo to the new branding.",
                    "status": "Stuck",
                    "priority": "Medium",

                    "dueDate": 1685212800000,
                    ...
                    "attachments": [
                        {
                            "id": "att-c101-1",
                            "url": "https://example.com/assets/new-logo.png",
                    ...
                    "checklists": [
                        {
                            ...
                            "todos": [
                                {
                                    "id": "todo-c101-1",
                                    "title": "Upload new logo assets",
                                    "isDone": false
                                },
                                {
                                    "id": "todo-c101-2",
                                    "title": "Check responsive sizing",
                                    "isDone": false
                                }
                            ]
                        }
                ...
                },
                {
                    ...
                    "_id": "c102",
                    "title": "Add Samples",
                    "description": "Add sample items and placeholders for new features.",
                    "status": "Done",
                    "priority": "Low",
                    "dueDate": 1685299200000,
            ...
            "tasks": [
                {
                    ...
                    "_id": "c103",
                    "title": "Help me",
                    "description": "Request assistance for code review or design tasks.",
                    "status": "Done",
                    "priority": "High",
                    "dueDate": 1685385600000,
                ...
                },
                {
                    ...
                    "_id": "c104",
                    "title": "Help me",
                    "description": "Duplicate task example, also needs assistance.",
                    "status": "Done",
                    "priority": "High",
                    "dueDate": 1685385600000,
                    ...
                    "activity": [
                        {
                            "id": "act-c104-1",
                            "text": "Completed the sub-tasks",
                            "timestamp": 1685203000000,
                            "byMember": {
                                "id": "m103",
                                "_id": "m103",
                                "fullname": "Ofek Tarablus",
                ...
                },
                {
                    ...
                    "_id": "c105",
                    "title": "Help me",
                    "description": "Ongoing assistance needed for partial tasks.",
                    "status": "Progress",
                    "priority": "Low",
                    "dueDate": 1685385600000,
            ...
            <div className="header-left">
                <div className="logo-section">
                    ...
                    <h1 className="product-title">
                        <span className="title-main">monday</span> <span className="title-sub">work management</span>
                    </h1>
                </div>
                ...
                <nav className="nav-icons">
                    ...
                    <div className="user-menu">
                        ...
                        <div className="user-img-combo">
                            <img src="https://cdn.monday.com/images/logos/monday_logo_icon.png" className="company-logo" alt="Company Logo" />
...
export function MondayTaskList({board}) {
    return (
        <section className="kanban-container-of-container flex">
            <div className="kanban-container flex">
                {board.groups.map((group) => (<MondayTask key={group.id} group={group}/>))}
            </div>
        </section>)
}
